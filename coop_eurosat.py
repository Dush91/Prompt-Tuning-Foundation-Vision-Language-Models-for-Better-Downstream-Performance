...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Proper CoOp EuroSAT Training Loss")
plt.grid(True)
plt.savefig(os.path.join(RESULTS_DIR, "proper_coop_eurosat_loss_graph.png"))
plt.show()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Proper CoOp EuroSAT Training Accuracy")
plt.grid(True)
plt.savefig(os.path.join(RESULTS_DIR, "proper_coop_eurosat_accuracy_graph.png"))
plt.show()
