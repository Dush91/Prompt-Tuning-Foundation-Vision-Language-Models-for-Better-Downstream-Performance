...
class PromptLearner(nn.Module):
    def __init__(self, classnames, clip_model, n_ctx=16):
        ...
        prompts = [
            "X " * n_ctx + f"a close-up photo of a {name} flower."
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Flowers102 CoOp Training Loss")
plt.grid(True)
plt.savefig(os.path.join(RESULTS_DIR, "flowers102_loss_graph.png"))
plt.show()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Flowers102 CoOp Training Accuracy")
plt.grid(True)
plt.savefig(os.path.join(RESULTS_DIR, "flowers102_accuracy_graph.png"))
plt.show()
