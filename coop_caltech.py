...
# SAVE CSV
# =====================
csv_path = os.path.join(RESULTS_DIR, "proper_coop_caltech101_results.csv")
...
# SAVE MODEL
# =====================
model_path = os.path.join(CHECKPOINT_DIR, "proper_coop_caltech101.pth")
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Proper CoOp Caltech101 Training Loss")
plt.grid(True)
plt.savefig(os.path.join(RESULTS_DIR, "proper_coop_caltech101_loss_graph.png"))
plt.show()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Proper CoOp Caltech101 Training Accuracy")
plt.grid(True)
plt.savefig(os.path.join(RESULTS_DIR, "proper_coop_caltech101_accuracy_graph.png"))
plt.show()
