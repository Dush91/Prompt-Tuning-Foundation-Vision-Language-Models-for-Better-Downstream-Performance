...
# SAVE CSV
# =====================
csv_path = os.path.join(RESULTS_DIR, "stl10_coop_results.csv")
...
# SAVE MODEL
# =====================
model_path = os.path.join(CHECKPOINT_DIR, "stl10_coop.pth")
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("STL-10 CoOp Training Loss")
plt.grid(True)

loss_graph_path = os.path.join(RESULTS_DIR, "stl10_loss_graph.png")
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("STL-10 CoOp Training Accuracy")
plt.grid(True)

accuracy_graph_path = os.path.join(RESULTS_DIR, "stl10_accuracy_graph.png")
